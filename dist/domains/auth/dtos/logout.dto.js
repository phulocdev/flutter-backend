...
__decorate([
    (0, class_validator_1.IsString)({ message: 'refreshToken phải là kiểu dữ liệu là string' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'refreshToken không được bỏ trống' }),
