...
__decorate([
    ...
    (0, class_validator_1.MinLength)(1, { message: 'description phải có ít nhất 1 kí tự' }),
    (0, class_validator_1.IsString)({ message: 'description phải là kiểu dữ liệu là string' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'description không được  bỏ trống' }),
    (0, class_transformer_1.Transform)(({ value }) => String(value).trim()),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.MaxLength)(20, { message: 'brand không được vượt quá 20 kí tự' }),
    (0, class_validator_1.MinLength)(1, { message: 'brand phải có ít nhất 1 kí tự' }),
    (0, class_validator_1.IsString)({ message: 'brand phải là kiểu dữ liệu là string' }),
...
__decorate([
    (0, class_validator_1.IsEnum)(enum_1.ProductStatus, {
        message: `status phải là một trong những giá trị sau: ${Object.values(enum_1.ProductStatus).join(' || ')}`
    }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateProductDto.prototype, "status", void 0);
__decorate([
    (0, class_validator_1.Min)(1, { message: 'basePrice phải > 0' }),
...
__decorate([
    ...
    (0, class_validator_1.MinLength)(3, { each: true, message: 'Mỗi phần tử trong attributeNames phải có ít nhất 3 ký tự' }),
...
__decorate([
    ...
    (0, class_validator_1.ValidateNested)({ each: true, message: 'Các phần tử trong skus không đúng định dạng' }),
