...
__decorate([
    (0, mongoose_1.Prop)({ type: Date, expires: '10m', default: Date.now }),
    __metadata("design:type", Date)
], Otp.prototype, "createdAt", void 0);
exports.Otp = Otp = __decorate([
    (0, mongoose_1.Schema)({ versionKey: false, timestamps: true, collection: 'Otp' })
], Otp);
exports.OtpSchema = mongoose_1.SchemaFactory.createForClass(Otp);
exports.OtpSchema.index({ otp: 1 }, { unique: true });
